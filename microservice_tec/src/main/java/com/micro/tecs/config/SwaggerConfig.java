...
public class SwaggerConfig {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.micro.tecs.controllers"))
                .paths(regex("/tec.*"))
                .build()
                .apiInfo(metaData());
    }
    ...
    private ApiInfo metaData2() {
        ApiInfo apiInfo = new ApiInfo(
                ...
                "1.0",
                "Terms of service",
                new Contact("Rafael Blanco", "https://github.com/rafabc", "rafabc1979@gmail.com"),
